...
#-----------------------------------------------------------------------------#
path_to_model = '/scratch/jm7432/my_project_foo/run-adventure-final/adventuremodel.npz'
path_to_dictionary = '/scratch/jm7432/my_project_foo/run-adventure-final/decoding/adventure_dict_final.pkl'
#-----------------------------------------------------------------------------#
def load_model():
    """
