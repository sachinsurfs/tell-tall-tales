...
#-----------------------------------------------------------------------------#
path_to_model = '/scratch/jm7432/my_project_foo/run-horror-final/horrormodel.npz'
path_to_dictionary = '/scratch/jm7432/my_project_foo/run-horror-final/decoding/horror_dict_final.pkl'
#-----------------------------------------------------------------------------#
def load_model():
    """
