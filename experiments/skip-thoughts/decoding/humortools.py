...
#-----------------------------------------------------------------------------#
path_to_model = '/scratch/jm7432/my_project_foo/run-humor-final/humormodel.npz'
path_to_dictionary = '/scratch/jm7432/my_project_foo/run-humor-final/decoding/humor_dict_final.pkl'
#-----------------------------------------------------------------------------#
def load_model():
    """
