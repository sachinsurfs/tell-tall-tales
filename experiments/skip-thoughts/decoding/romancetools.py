...
#-----------------------------------------------------------------------------#
path_to_model = '/scratch/jm7432/my_project_foo/run-romance/romancemodel.npz'
path_to_dictionary = '/scratch/jm7432/my_project_foo/run-romance/decoding/romance_dict_final.pkl'
#-----------------------------------------------------------------------------#
def load_model():
    """
